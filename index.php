...
<body>
        ...
        <div class="content">
            ...
            <div class="socials">
                <ul class="social-icons">
                    <li><a class="linkedin" aria-label="LinkedIn" href="https://www.linkedin.com/in/soumay-kumar359" target="_blank"><i class="fab fa-linkedin"></i></a></li>
                    <li><a class="github" aria-label="GitHub" href="https://github.com/Soumaykumar25" target="_blank"><i class="fab fa-github"></i></a></li>
                    ...
                    <li><a class="dev" aria-label="Dev" href="https://www.youtube.com/@soumaykumar359" target="_blank"><i class="fa-brands fa-youtube"></i></a></li>
                </ul>
            </div>
        </div>
        <div class="image">
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            <div class="image">
                <img src="./images/image3.jpg" draggable="false" class="tilt" alt="Hero" />
            </div>
            <div class="content">
                <h3>Hello, I'm Soumay</h3>
                ...
                <div class="profilebtn" style="margin-bottom:0px;">
                    <a href="https://www.linkedin.com/in/soumay-kumar359" target="_blank" class="btn"><span>View my profile</span>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <div class="card h-100 d-flex align-items-stretch">
                    ...
                    <div class="card-body">
                        <h5 class="card-title" style="font-size: 2.5rem; text-align: center;"><strong>JAVA Tutorials for Beginners in Hindi</strong></h5>
                        ...
                        <a href="https://youtube.com/playlist?list=PL3ANP9kKTfRaW7IMKXwkxCYBobat33cJg&si=MuVXR039ed_TIsKS" class="btn btn-success fw-bold m-2 d-flex justify-content-center" id="bookbtn">View for free</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100 d-flex align-items-stretch">
                    ...
                    <div class="card-body">
                        ...
                        <a href="https://youtube.com/playlist?list=PL3ANP9kKTfRb4sEX39TaRwlyyJNJqr6IB&si=QRW-7FbkY4gMRGZz" class="btn btn-success fw-bold m-2 d-flex justify-content-center" id="bookbtn">View for free</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card h-100 d-flex align-items-stretch">
                    <img src="./images/course3.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title"><strong> Full Stack Web Development Full Course</strong></h5>
                        <p class="card-text">Here you can learn Web Development from scratch. This course will include Full Stack Web Development HTML, CSS, JAVASCRIPT With MERN Stack Framework</p>
                        <a href="https://youtube.com/playlist?list=PLDzeHZWIZsTo0wSBcg4-NMIbC0L8evLrD&si=MxMXl3KtTRzdlQoG" class="btn btn-success fw-bold m-2 d-flex justify-content-center" id="bookbtn">View for free</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-wrap -m-4">
            <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
                <div class="h-full text-center">
                    <img alt="testimonial" class="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="./images/als.png">
            ...
            <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
                <div class="h-full text-center">
                    <img alt="testimonial" class="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="./images/als2.png">
                    <p class="leading-relaxed">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                    <span class="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4"></span>
            ...
            <div class="lg:w-1/3 lg:mb-0 p-4">
                <div class="h-full text-center">
                    <img alt="testimonial" class="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="./images/als3.png">
                    <p class="leading-relaxed">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                    <span class="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4"></span>
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a class="text-indigo-500">soumaykumar25@email.com</a>
...
<section class="footer">
  ...
  <div class="box-container">
      ...
      <div class="box">
          <h3>contact info</h3>
          <p> <i class="fas fa-phone"></i>+91 925-XXX-XXXX</p>
          <p> <i class="fas fa-envelope"></i>soumaykumar25@gmail.com</p>
          <p> <i class="fas fa-map-marked-alt"></i>Moradabad UP, India</p>
          <div class="share">
              <a href="https://www.linkedin.com/in/soumay-kumar359" class="fab fa-linkedin" aria-label="LinkedIn" target="_blank"></a>
              <a class="github" aria-label="GitHub" href="https://github.com/Soumaykumar25" target="_blank"><i class="fab fa-github"></i></a>
              <a href="mailto:soumaykumar25@gmail.com" class="fas fa-envelope" aria-label="Mail" target="_blank"></a>
              <a href="#" class="fab fa-telegram-plane" aria-label="Telegram" target="_blank"></a>
              <a href="https://www.youtube.com/@soumaykumar359" target="_blank" class="fa-brands fa-youtube" aria-label="Youtube"></a>
            </div>
      </div>
  </div>

  <h1 class="credit">Designed with <i class="fa fa-heart pulse"></i> by <a href="https://www.linkedin.com/in/soumay-kumar359">Soumay Kumar</a></h1>
